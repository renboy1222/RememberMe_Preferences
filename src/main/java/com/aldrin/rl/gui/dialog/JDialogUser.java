 ...
 */
package com.aldrin.rl.gui.dialog;


import com.aldrin.rl.dao.impl.UserDAOImpl;
import com.aldrin.rl.gui.JFrameApp;
import com.aldrin.rl.gui.dialog.au.JDialogUserAU;
...
public class JDialogUser extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogUser(JFrameApp jFrameCafSys, boolean modal) {
    ...
    private void initComponents() {
        ...
        jButtonNew.setPreferredSize(new java.awt.Dimension(110, 40));
        ...
        jButtonUpdate.setPreferredSize(new java.awt.Dimension(110, 40));
        ...
        jTextFieldSearch.setPreferredSize(new java.awt.Dimension(250, 40));
...
//"ID", "ROLE ID", "FIRST NAME", "SURNAME", "ROLE", "USERNAME", "PASSWORD", "ACTIVE"
    ...
    private void selectUserAccount() {
        ...
        for (User u : userAccountList) {
            tableModel.addRow(new Object[]{u.getId(), u.getRole().getId(), u.getFirstname(), u.getSurname(), u.getRole().getRole(), u.getUsername(), u.getPassword(), u.getActive()});
        }
    }

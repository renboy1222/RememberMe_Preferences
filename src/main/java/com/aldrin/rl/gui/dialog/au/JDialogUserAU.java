 ...
 */
package com.aldrin.rl.gui.dialog.au;



import com.aldrin.rl.RememberLogin2;
import com.aldrin.rl.dao.impl.RoleDAOImpl;
...
public class JDialogUserAU extends javax.swing.JDialog {
        ...
        try {
            ...
            if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    ImageIO.write(resizedImage, "png", new File(RememberLogin2.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\model.jpg"));
    ...
    private void validatePhoto() throws URISyntaxException {
        if (userAccount.getPhoto() == null) {
            File targetClassesDir = new File(RememberLogin2.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\photo.jpg");
            try {
